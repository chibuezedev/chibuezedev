...
- Building a video-based content moderation system for social media platform (Pozse),
- Building video and image processing infrastructure for vision-driven systems,
- Designing computer vision–ready pipelines with rich metadata extraction
- Implementing media systems with retries, logging, summaries, and interactive debugging tools
- Applying this infrastructure to real-world use cases,
- Exploring cost-efficient ML deployment for batch and streaming perception workloads. etc.
